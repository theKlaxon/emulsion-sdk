"Options"
{
	...
	"Blobulator"
	{
		"title"			"#GameUI_Blobulator"
		"alternating"   "1"
		"items"
		{
			"Render Quality"
			{
				"text"			"#GameUI_BlobQuality"
				"type"			"wheelywheel"
				"convar"		"r_paintblob_blr_menu_cubewidths"

				"options"
				{
					"0"	"#GameUI_BlobQuality_Normal"
					"1"	"#GameUI_BlobQuality_High"
					"2"	"#GameUI_BlobQuality_VeryHigh"
				}
			}
