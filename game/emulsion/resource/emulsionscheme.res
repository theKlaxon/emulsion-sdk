...
Scheme
{
	...
	Colors
	{
		...
		"LightBlue"			"255 255 255 255"
		"GreyBlue"			"128 128 128 255"
		"DarkBlueTrans"			"64 64 64 64"
		"Blue"				"211 211 211 255"
		"HighlightBlue"		"145 145 145 255"
	...
	BaseSettings
	{
		...
		Label.TextBrightColor			"OffWhite"
	...
	// Custom styles for use with L4D360HybridButtons
		...
		HybridButton.BorderColor					"OffWhite"
		HybridButton.BlotchColor					"White"
		HybridButton.TextColor 						"White"

		// These bypass all of CA's horrific style.  Look/Feel is code based
			
		// main or ingame menu only
		MainMenuButton.TextColor 					"Grey"
