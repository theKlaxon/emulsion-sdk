...
// this version is for compat with particles lib
void CBeamSegDraw::Start(IMatRenderContASW* pRenderContext, int nSegs, IMaterial* pMaterial, CMeshBuilder* pMeshBuilder, int nMeshVertCount)
{
	Assert(nSegs >= 2);
