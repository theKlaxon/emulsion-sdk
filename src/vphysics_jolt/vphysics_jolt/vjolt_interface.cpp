...
{
	Msg("Freeing mem: %i\n", sizeof((*static_cast<JoltPhysicsObjectPairHash*>(pHash))));
	MemAlloc_Free((void**)static_cast<JoltPhysicsObjectPairHash*>(pHash));

	//g_pMemAlloc->Free(static_cast<JoltPhysicsObjectPairHash*>(pHash));
