...
rem // BUILD PBR
%BUILD_SHADER% pbr/pbr_dx9_20b		-game %GAMEDIR% -source %SOURCEDIR%
%BUILD_SHADER% pbr/pbr_dx9_30		-game %GAMEDIR% -source %SOURCEDIR% -dx9_30	-force30

rem // BUILD GAME
%BUILD_SHADER% emulsion/emulsion_dx9_20b	-game %GAMEDIR% -source %SOURCEDIR%
%BUILD_SHADER% emulsion/emulsion_dx9_30		-game %GAMEDIR% -source %SOURCEDIR% -dx9_30	-force30
