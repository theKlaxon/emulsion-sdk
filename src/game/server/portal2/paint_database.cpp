...
{
	CEG_GCV_PRE();
	static const PaintPowerType CEG_NO_POWER = (PaintPowerType)CEG_GET_CONSTANT_VALUE( PaintNoPower );
	CEG_GCV_POST();
...
void CPaintDatabase::PreClientUpdate()
{
	...
	{
		CBasePlayer *pPortalPlayer = ToBasePlayer( UTIL_PlayerByIndex( i ) );
