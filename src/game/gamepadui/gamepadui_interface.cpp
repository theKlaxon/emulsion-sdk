...
IBik* bik;
#endif
// TODO: AVI SUPPOOOORRTTTTT!

// memdbgon must be the last include file in a .cpp file!!!
#include "tier0/memdbgon.h"

// TODO: #ifdef!!!!!!!!!! this is for portal 2 only!!!!!!!! (Klaxon)
static CUtlVector<int> emptyForDummy;
class CAchievementMgrDummy : public IAchievementMgr {
public:
    virtual IAchievement* GetAchievementByIndex(int index, int nPlayerSlot) { return nullptr; }
    virtual IAchievement* GetAchievementByDisplayOrder(int orderIndex, int nPlayerSlot) { return nullptr; }
    virtual CBaseAchievement* GetAchievementByID(int id, int nPlayerSlot) { return nullptr; }
    virtual int GetAchievementCount() { return 0; }
    virtual void InitializeAchievements() {}
    virtual void AwardAchievement(int nAchievementID, int nPlayerSlot) {}
    virtual void OnMapEvent(const char* pchEventName, int nPlayerSlot) {}
    virtual void SaveGlobalStateIfDirty() {}
    virtual bool HasAchieved(const char* pchName, int nPlayerSlot) { return false; }
    virtual const CUtlVector<int>& GetAchievedDuringCurrentGame(int nPlayerSlot) { return emptyForDummy; }
} static s_AchieveDummy;
// 
...
void GamepadUI::Initialize( CreateInterfaceFn factory )
{
    ...
    // we use the clientside gameui here now
    ...
    m_pAchievementMgr = (IAchievementMgr*)&s_AchieveDummy;// m_pEngineClient->GetAchievementMgr();
    ...
    m_pGameUI->SetupGamepadUIClientPanel();
