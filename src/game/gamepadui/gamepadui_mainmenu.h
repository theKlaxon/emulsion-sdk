...
using namespace GamepadUIMenuStates;// = GamepadUIMenuStates::GamepadUIMenuState;
...
private:
    ...
    GAMEPADUI_PANEL_PROPERTY( Color, m_colLogoColor, "Logo", "255 255 255 255", SchemeValueTypes::Colour);
