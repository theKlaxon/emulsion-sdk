...
// DO NOT under ANY CIRCUMSTANCE let this shit DO THE THING
// just cause idrk what'd happen, or if VAC / steam would get mad
...
void CUIGameData::GameStats_ReportAction( char const *szReportAction, char const *szMapName, uint64 uiFlags )
{
	...
	// Send these stats to OGS	// nahhhhhhhhh
