...
void COptionsSubKeyboard::CreateKeyBindingList()
{
	...
	//m_pKeyBindList->GetScrollBar()->UseImages( "scroll_up", "scroll_down", "scroll_line", "scroll_box" ); // TODO: replace this in vgui_controls
}
...
void COptionsSubKeyboard::OnThink()
{
	...
	// TODO: replace this in vgui_controls
