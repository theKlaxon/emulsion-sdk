...
// >> Portal_Player
//=============================================================================
class C_Portal_Player : public C_BasePlayer//C_BaseHLPlayer
{
public:
	DECLARE_CLASS( C_Portal_Player, C_BasePlayer);
	...
	virtual int				NoDrawPortalSurface() { return m_iForceNoDrawInPortalSurface; }
