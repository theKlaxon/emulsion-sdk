...
#define XBX_GetPrimaryUserId() XBX_GetActiveUserId() //_Use_XBX_GetActiveUserId_Instead // just redirect it like i did. this did not need to be done like it was. no good.
