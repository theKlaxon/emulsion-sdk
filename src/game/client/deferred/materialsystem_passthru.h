...
public:
	...
	virtual bool				IsRenderThreadSafe() { return m_pBaseMaterialsPassThru->IsRenderThreadSafe(); } // p2
	...
	// 0x0001a090 // TODO:
	virtual const AspectRatioInfo_t& GetAspectRatioInfo() { return m_pBaseMaterialsPassThru->GetAspectRatioInfo(); }
	...
	virtual unsigned int		GetCurrentFrameCount() { return m_pBaseMaterialsPassThru->GetCurrentFrameCount(); } // 0x00017dc0
	...
	// p2
	virtual void				OnLevelShutdown() { m_pBaseMaterialsPassThru->OnLevelShutdown(); }
	virtual bool				AddOnLevelShutdownFunc(void* par1, void* par2) { return m_pBaseMaterialsPassThru->AddOnLevelShutdownFunc(par1, par2); }
	virtual bool				RemoveOnLevelShutdownFunc(void* par1, void* par2) { return m_pBaseMaterialsPassThru->RemoveOnLevelShutdownFunc(par1, par2); }
	// --
	...
	virtual bool IsMaterialLoaded(const char* par1) { return m_pBaseMaterialsPassThru->IsMaterialLoaded(par1); } // p2
	...
	virtual ITexture* FindTexture(char const* pTextureName, const char* pTextureGroupName, bool complain = true, int flags = 0) { return m_pBaseMaterialsPassThru->FindTexture(pTextureName, pTextureGroupName, complain, flags); }
	...
	virtual void				CleanupLightmaps() { m_pBaseMaterialsPassThru->CleanupLightmaps(); } // p2
	...
	// p2
	virtual bool				IsStereoSupported() { return m_pBaseMaterialsPassThru->IsStereoSupported(); }
	...
	virtual void SpinPresent(uint nFrames) { m_pBaseMaterialsPassThru->SpinPresent(nFrames); } // p2
	...
	// par1 is type GPUMemoryStats TODO: add this type
	virtual void				GetGPUMemoryStats(void* par1) { m_pBaseMaterialsPassThru->GetGPUMemoryStats(par1); }
	...
	virtual void				EndUpdatePaintmaps(void) { m_pBaseMaterialsPassThru->EndUpdatePaintmaps(); }
	virtual void				UpdatePaintmap(int par1, unsigned char* par2, int par3, Rect_t par4) { m_pBaseMaterialsPassThru->UpdatePaintmap(par1, par2, par3, par4); }

	// 0x00019030
	// copied the fucking params from ghidra cause fuck typing that
	virtual ITexture* CreateNamedMultiRenderTargetTexture(char* param_1,
		...
		uint param_7, uint param_8) { return m_pBaseMaterialsPassThru->CreateNamedMultiRenderTargetTexture(param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8); }
