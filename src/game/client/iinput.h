...
public:
	...
	// new p2 stuff
	virtual void SetControllerModeActive(int par1, bool par2) = 0;
	virtual bool		ControllerModeActive(int par1) = 0;
	virtual void SetLastUsedInput(int par1) = 0;
	virtual int GetLastUsedInput() = 0; // int return type is a guess TODO: double check
