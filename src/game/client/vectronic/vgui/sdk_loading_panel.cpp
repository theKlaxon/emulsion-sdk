...
CSDK_Loading_Panel *g_pSDK_Loading_Panel = NULL;

CUtlVector<CSDK_Loading_Panel *> g_vecLoadingPanels;
...
{
	if ( NULL == g_pSDK_Loading_Panel )
	{
		g_pSDK_Loading_Panel = new CSDK_Loading_Panel();
	}
	return g_pSDK_Loading_Panel;
}
...
void DestroySDKLoadingPanel()
{
	if ( NULL != g_pSDK_Loading_Panel )
	{
		delete g_pSDK_Loading_Panel;
		g_pSDK_Loading_Panel = NULL;
	}
}
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CSDK_Loading_Panel::CSDK_Loading_Panel() : BaseClass( NULL, "SDK_Loading_Panel", 
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CSDK_Loading_Panel::CSDK_Loading_Panel( vgui::Panel *parent ) : BaseClass( parent, "TFStatsSummary", 
																		  vgui::scheme()->LoadSchemeFromFile( "Resource/ClientScheme.res", "ClientScheme" ) )
{
	Init();
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CSDK_Loading_Panel::PerformLayout()
{
...
//-----------------------------------------------------------------------------
void CSDK_Loading_Panel::ApplySchemeSettings(vgui::IScheme *pScheme)
{
...
void CSDK_Loading_Panel::GetLoadingScreenSize(int &w, int &t, int &xoffset)
{
	int sw, sh;
	vgui::surface()->GetScreenSize( sw, sh );
...
void CSDK_Loading_Panel::FireGameEvent( IGameEvent *event )
{
...
void CSDK_Loading_Panel::SetLoadingMapName( const char *szMapName )
{
	m_pDetailsPanel->SetVisible( false );
	if ( !szMapName )
		return;
...
void CSDK_Loading_Panel::SetGenerationOptions( KeyValues *pKeys )
{
