...
public:
	...
	// vtable update
	virtual void			SetControllerModeActive(int par1, bool par2) {}
	virtual bool			ControllerModeActive(int par1);
	virtual void			SetLastUsedInput(int par1) {}
	virtual int				GetLastUsedInput() { return 0; } // int return type is a guess TODO: double check

	virtual		void		Joystick_Advanced( bool bSilent );
	virtual		void		Joystick_SetSampleTime(float frametime);

	virtual long double		Joystick_GetPitch() { return 0.0; } // float10 return type in ghidra... wtf is even that
	virtual long double		Joystick_GetYaw() { return 0.0; }
	virtual void			Joystick_Querry(float* par1, float par2, float par3, float par4) {}
	virtual void			Joystick_ForceRecentering(int par1, bool par2) {}
	...
	//virtual void			ClearInputButton(int par1);
...
protected:
	...
	//virtual void	SteamControllerMove(int par1, float par2, CUserCmd* par3) {}
