...
#include "vectronic_gamemovement.h"
...
static CVectronicGameMovement g_GameMovement;
IGameMovement* g_pGameMovement = (IGameMovement*)&g_GameMovement;

EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CVectronicGameMovement, IGameMovement, INTERFACENAME_GAMEMOVEMENT, g_GameMovement);

CVectronicGameMovement::CVectronicGameMovement() {
...
void CVectronicGameMovement::ProcessMovement(CBasePlayer* pPlayer, CMoveData* pMove) {
...
void CVectronicGameMovement::PlayerMove()
{
...
void CVectronicGameMovement::CategorizePosition(void)
{
...
void CVectronicGameMovement::FullWalkMove()
{
...
void CVectronicGameMovement::WalkMove()
{
	int i;
...
void CVectronicGameMovement::AirMove()
{
...
void CVectronicGameMovement::Friction()
{
...
void CVectronicGameMovement::CheckParameters()
{
	QAngle	v_angle;
...
void CVectronicGameMovement::CheckFalling()
{
...
void CVectronicGameMovement::StayOnGround()
{
...
void CVectronicGameMovement::StartGravity() {
...
void CVectronicGameMovement::FinishGravity() {
	if (player->m_flWaterJumpTime)
		return;
...
void CVectronicGameMovement::SetGroundEntity(trace_t* pm)
{
	Vector nAxis = GetGravityDir();
	VecNeg(nAxis);
...
bool CVectronicGameMovement::CheckJumpButton() {
...
#if defined(GAME_DLL) && !defined(VECTRONIC_DLL)
...
int CVectronicGameMovement::TryPlayerMove(Vector* pFirstDest, trace_t* pFirstTrace)
{
...
void CVectronicGameMovement::ProcessPowerUpdate() {
#if defined(GAME_DLL) && !defined(VECTRONIC_DLL)
...
void CVectronicGameMovement::BouncePlayer(cplane_t plane, float multiplier) {
...
void CVectronicGameMovement::CalculateStickAngles() {
...
void CVectronicGameMovement::UnStickPlayer() {
	SetGravityDir(Vector(0, 0, -1));
	player->SetMoveType(MOVETYPE_WALK);
}

void CVectronicGameMovement::PlayPaintEntrySound(PaintPowerType type, bool force) {
...
void CVectronicGameMovement::PlayPaintExitSound(PaintPowerType type) {
...
void CVectronicGameMovement::DetermineExitSound(PaintPowerType type) {
...
void CVectronicGameMovement::PlaySoundInternal(const char* sound) {
...
PaintInfo_t CVectronicGameMovement::CheckPaintedSurface() {
...
PaintPowerType CVectronicGameMovement::GetHighestPriorityPaint(CUtlVector<unsigned char>* m_pPowers) {
