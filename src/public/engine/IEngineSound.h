...
//private:
	...
	virtual int EmitSound(IRecipientFilter& filter, int iEntIndex, int iChannel, const char* pSample,
		HSOUNDSCRIPTHANDLE u1, const char* u2, float flVolume, float flAttenuation, int iFlags = 0, int iPitch = PITCH_NORM, int u3 = 0,
	...
	//	EmitSound(filter, iEntIndex, iChannel, pSample, SOUNDEMITTER_INVALID_HANDLE, "", flVolume, flAttenuation, iFlags, iPitch, 0, pOrigin, pDirection, pUtlVecOrigins, bUpdatePositions, soundtime, speakerentity);
	...
	//	EmitSound(filter, iEntIndex, iChannel, pSample, SOUNDEMITTER_INVALID_HANDLE, "", flVolume, iSoundlevel, iFlags, iPitch, 0, pOrigin, pDirection, pUtlVecOrigins, bUpdatePositions, soundtime, speakerentity);
	//}
