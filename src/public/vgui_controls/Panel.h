...
public:
	...
	virtual bool IsFullyVisible() { return true; }
	...
	VPANEL IsWithinTraverse(int x, int y, bool traversePopups);	// recursive; returns a pointer to the panel at those coordinates
	...
	virtual bool LookupElementBounds(int* param_2, int* param_3, int* param_4, int* param_5) { return 0; }
	...
	void DeletePanel();				// simply does a  { delete this; }
	...
	virtual void OnUnserialized(void* par1) {}
	...
	// TODO: GetPanelMap???????
	//virtual void GetPanelMap();// { return NULL; }
...
// Drag Drop Public interface
	...
	virtual HCursor GetDragFailCursor(CUtlVector<KeyValues*>& par1) { return dc_no; }
	...
	virtual Panel* NavigateActivate(); // TODO: ??
	virtual Panel* NavigateBack(); // TODO: ??
