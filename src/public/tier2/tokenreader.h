...
// im not gonna waste time hex editing the stupid obj file,
// when the 2006 sdk has it open source. WHY IN GODS NAME DID
// VALVE DECIDE "oh, they dont need that file anymroe""""????????????????!!!!!!!!!!!
