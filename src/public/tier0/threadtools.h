...
protected:
	...
	// virtual int Run() = 0;
	// wtf why this not here in the new lib?????!! fuckign weird ass shit
...
private:
	...
	virtual unsigned long GetThreadProc();
...
// before interface changes from libtier0.dylib depot 620 623
//class PLATFORM_CLASS CThread
//{
//public:
//	CThread();
