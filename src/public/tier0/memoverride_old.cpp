...
#if defined( _DEBUG ) && !defined( EMULSION_DLL ) && !defined(INFESTED_DLL) && !defined(GAME_SHADER_DLL)
...
#if !defined (GAMEPADUI_DLL) && !defined(PLUGIN_DLL) && !defined(GAME_SHADER_DLL)
    LC_ID       _cacheid;
#endif
	UINT        _cachecp;
