...
public:
	...
	// 0x0000c000
	virtual void DrawSetApparentDepth(float depth) = 0; // par1 def gotta be depth
	// 0x0000c010
	...
	//virtual void NotFound404() {}; // disappeared from vtable
	...
	// 0x00011b50
	virtual void GetKernedCharWidth(unsigned long par1, wchar_t par2, wchar_t par3, wchar_t par4, float& par5, float& par6, float& par7) = 0;

	// 0x00016a00
	virtual void DrawUpdateRegionTextureRGBA(int par1, int par2, int par3, const unsigned char* par4, int par5, int par6, ImageFormat par7) = 0;

	// 0x00016860
	virtual bool BHTMLWindowNeedsPaint(IHTML* html) = 0;

	// 0x00016910
	virtual void DrawSetTextureRGBALinear(int par1, const unsigned char* par2, int par3, int par4) = 0;
