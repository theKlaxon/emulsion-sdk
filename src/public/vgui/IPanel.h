...
public:
	...
	void SetMessageContextId(VPANEL vguiPanel, int nContextId) {}
	int GetMessageContextId(VPANEL vguiPanel) { return 0; }

	const DmxElementUnpackStructure_t* GetUnpackStructure(VPANEL vguiPanel) const { return NULL; }
	void OnUnserialized(VPANEL vguiPanel, CDmxElement* pElement) {}
