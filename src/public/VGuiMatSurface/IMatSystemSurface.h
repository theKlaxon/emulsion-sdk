...
public:
	...
	// TODO: virtual bool IsCursorLocked() const = 0;
	// i think was remove :(
	...
	virtual void DrawSetSubTextureRGBA(int par1, int par2, int par3, 
		unsigned char* par4, int par5, int par6) = 0;
	virtual void DrawTexturedSubRectGradient(int param_1, int param_2, int param_3, int param_4, float param_5,
		float param_6, float param_7, float param_8, Color param_9, Color param_10, bool param_11) = 0;
};
