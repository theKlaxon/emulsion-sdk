...
//			string formatting
//
// Note: some changes are taken from ASW:RD. Thanks ASW:RD!
// 
// $NoKeywords: $
//=============================================================================//
...
// last arg goes unused in this version, i simply added it so that the updated CFmtStrN will still work with older compilers using the same code
#define FmtStrVSNPrintf( szBuf, nBufSize, ppszFormat, lastArg ) \
	do \
	{ \
		int     result; \
...
// TODO: this is now incompatible with older compilers. do something!
...
public:
	...
	{
		FmtStrVSNPrintf(m_szBuf, SIZE_BUF, ppszFormat, params);
	}
#else
