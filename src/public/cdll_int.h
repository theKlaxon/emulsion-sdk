...
// For non-split screen games this will always be zero
	...
	virtual void SphereTracePaintSurface(model_t* param_1, Vector* param_2, Vector* param_3, float param_4, CUtlVector<unsigned char*> param_5) = 0;
...
public:
	...
	virtual void ReplayUI_SendMessage(KeyValues* par1) = 0;
