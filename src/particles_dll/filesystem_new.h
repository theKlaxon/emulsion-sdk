...
//-----------------------------------------------------------------------------
abstract_class IFileSystemNew : public IAppSystem, public IBaseFileSystem
{
public:
	//--------------------------------------------------------
	// Steam operations
	...
	virtual void			FindFileAbsoluteList(CUtlVector< CUtlString >& p0, const char* p1, const char* p2) = 0;
...
inline unsigned IFileSystemNew::GetOptimalReadSize( FileHandle_t hFile, unsigned nLogicalSize ) 
{ 
	unsigned align; 
