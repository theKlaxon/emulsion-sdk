...
#undef GetCurrentDirectory
	...
	virtual KeyValues* LoadKeyValues(KeyValuesPreloadType_t type, char const* filename, char const* pPathID = 0) { return filesystem->LoadKeyValues((IFileSystemNew::KeyValuesPreloadType_t)type, filename, pPathID); }
	virtual bool		LoadKeyValues(KeyValues& head, KeyValuesPreloadType_t type, char const* filename, char const* pPathID = 0) { return filesystem->LoadKeyValues(head, (IFileSystemNew::KeyValuesPreloadType_t)type, filename, pPathID); }
